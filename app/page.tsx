...
export default function Home() {
  ...
  // Logic to hide the stats when the Emergency Banner appears
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        // If the banner is visible, hide the stats
        setIsVisible(!entry.isIntersecting);
      },
      { threshold: 0.1 }, // Trigger as soon as 10% of the banner is seen
    );
      ...
      <div className="pt-20">
        ...
        <section className="relative h-[90vh] flex items-center overflow-hidden bg-charcoal">
            ...
            >
              <div className="inline-block bg-road-yellow text-charcoal px-4 py-1 font-display text-xl font-black uppercase mb-6 skew-x-[-12deg]">
                <span className="skew-x-[12deg] block">
                  NZ'S LINE MARKING SPECIALISTS
                </span>
              </div>
              <h1 className="text-6xl md:text-8xl text-white font-black leading-[0.9] mb-8">
                PRECISION <span className="text-road-yellow">ON THE LINE.</span>
                <br />
                SAFETY ON THE ROAD.
              </h1>
          ...
          <motion.div
            initial={{ x: 100 }}
            animate={{
              x: isVisible ? 10 : 500, // Slides off screen when hidden
              opacity: isVisible ? 1 : 0,
            }}
            transition={{ duration: 0.5, ease: "circOut" }}
            className="fixed bottom-0 right-0 hidden lg:flex bg-road-yellow skew-x-[-12deg] p-8 z-50 shadow-2xl"
          >
            <div className="skew-x-[12deg] flex space-x-12 pr-12">
              {stats.map((stat) => (
                <div key={stat.label} className="text-charcoal">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-16">
              <div className="max-w-2xl">
                ...
                <p className="text-xl text-gray-600">
                  From high-speed motorways to industrial warehouses, we deliver
                  markings that last.
                </p>
              </div>
              <Link
                href="#"
                className="hidden md:flex items-center text-charcoal font-display text-xl font-black uppercase hover:text-road-yellow transition-colors mt-8 md:mt-0"
              >
              ...
              {services.map((service, idx) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 p-8 w-full">
                    ...
                    <h3 className="text-3xl text-white font-black mb-2">
                      {service.title}
                    </h3>
                    ...
                    <Link
                      href="#"
                      className="inline-flex items-center text-road-yellow font-display text-lg font-black uppercase"
                    >
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-1/2">
                <h2 className="text-5xl md:text-6xl text-white font-black mb-6">
                  WE HANDLE THE{" "}
                  <span className="text-road-yellow">TRAFFIC.</span>
                </h2>
                <p className="text-xl text-gray-300 mb-8">
                  Don't worry about the cones. We provide full traffic
                  management services for every job, ensuring safety for our
                  crew and the public. STMS qualified and ready.
                </p>
                <ul className="space-y-4 mb-10">
                  {[
                    "Full STMS Site Setup",
                    "TMP Planning & Approval",
                    "Night Work Specialists",
                    "Safety First Approach",
                  ].map((item) => (
                    <li
                      key={item}
                      className="flex items-center text-white font-display text-xl uppercase italic"
                    >
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See the difference professional line marking makes.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="relative aspect-video overflow-hidden rounded-lg">
                  <img
                    src="https://picsum.photos/seed/before/800/600?grayscale"
                    className="w-full h-full object-cover"
                    alt="Before"
                  />
                  <div className="absolute top-4 left-4 bg-charcoal text-white px-3 py-1 font-display uppercase">
                    BEFORE
                  </div>
                </div>
                <div className="relative aspect-video overflow-hidden rounded-lg">
                  <img
                    ...
                    alt="After"
                  />
                  <div className="absolute top-4 left-4 bg-road-yellow text-charcoal px-3 py-1 font-display uppercase font-black">
                    AFTER
                  </div>
                </div>
              </div>
              <div className="flex flex-col justify-center bg-charcoal p-12 text-white skew-x-[-2deg]">
                <div className="skew-x-[2deg]">
                  <h3 className="text-4xl font-black text-road-yellow mb-6 italic">
                    "TRANSFORMED OUR FACILITY"
                  </h3>
                  <p className="text-xl text-gray-300 mb-8">
                    "The team at LinePro completely overhauled our warehouse
                    layout. The new safety markings have significantly improved
                    our operational flow and safety compliance."
                  </p>
                  <div className="flex items-center">
                    ...
                    <span className="font-display text-xl uppercase">
                      — Operations Manager, Logistics NZ
                    </span>
                  </div>
                </div>
              </div>
        ...
        <section ref={bannerRef} className="bg-road-yellow py-12 overflow-hidden">
          ...
          >
            {[...Array(10)].map((_, i) => (
              <span
                key={i}
                className="text-4xl md:text-6xl font-black text-charcoal font-display uppercase mx-8"
              >
