    ...
    <footer className="bg-charcoal text-white pt-16 pb-8 border-t-8 border-road-yellow relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-6">
            <div className="bg-road-yellow p-1 inline-block skew-x-[-12deg]">
              <span className="text-charcoal font-black text-3xl px-2 block skew-x-[12deg]">
                LINEPRO
              </span>
            </div>
            <p className="text-gray-400 max-w-xs">
              New Zealand's leading road marking and line painting specialists.
              Rugged quality, precision marking, 24/7 availability.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="hover:text-road-yellow transition-colors">
                <Facebook />
              </a>
              <a href="#" className="hover:text-road-yellow transition-colors">
                <Instagram />
        ...
        <div className="mt-16 pt-8 border-t border-white/10 text-center text-gray-500 text-sm">
          <p>
            &copy; {new Date().getFullYear()} LinePro Road Marking Ltd. All
            Rights Reserved.
          </p>
        </div>
      </div>
